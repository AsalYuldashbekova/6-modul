...
# #     return color
# #
# # clr1 = canvas.create_rectangle(10, 20, 30, 35, fill="Black")
# # canvas.tag_bind(clr1, "<Button-1>", lambda x: show_color("Black"))
# # clr2 = canvas.create_rectangle(10, 55, 30, 70, fill="green")
# # canvas.tag_bind(clr2, "<Button-1>", lambda x: show_color("Green"))
# # clr3 = canvas.create_rectangle(10, 90, 30, 105, fill="red")
# # canvas.tag_bind(clr3, "<Button-1>", lambda x: show_color("red"))
# #
# # window.bind("<Button-1>", location_mouse)
# # window.bind("<B1-Motion>", create_line)
# #
# # mainloop()
#
